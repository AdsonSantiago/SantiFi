...
SECRET_KEY = 'django-insecure-hw0w=o#_%ysx*hh+8b$j_r-*n@lw)z#j!loercr&ncv8bc3l83'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # <-- para vercel aceitar
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # <-- evita falha vercell
